...
<body>
    ...
    <div>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator22" runat="server" 
            ControlToValidate="RadioButtonList1" ErrorMessage="Gender Required" 
        ...
        <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" 
            ...
            ErrorMessage="Contact Number should be Numeric and 10 Digits only" 
            ForeColor="Red" SetFocusOnError="True" ValidationExpression="^\d{10}$"></asp:RegularExpressionValidator>
        <br />
        ...
        <asp:ValidationSummary ID="ValidationSummary1" runat="server" 
            ShowMessageBox="True" Width="553px" />
        <br />
        <br />
        <br />
